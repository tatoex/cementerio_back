...
class Tumba (models.Model):
    ...
    loadDate=models.mDateTimeField(auto_now_add=True, verbose_name='creacion')
    updateDate=models.mDateTimeField(auto_now=True, verbose_name='actualizacion')
    name=models.ForeignKey(Lote, related_name='tumba', on_delete=models.CASCADE) 
...
class DisponibleTumba (models.Model):
    ...
    number=models.ForeignKey(Tumba, related_name='disponibleTumba', on_delete=models..DO_NOTHING) 
