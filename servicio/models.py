...
class Servicio(BaseModelServicio):
    ...
    endDate = models.DateTimeField( blank=True, verbose_name='vecimiento')
    ceremony = models.CharField(max_length=50,  blank=True, verbose_name='tipo', choices= TIPO_CEREMONIA_CHOICES)
    is_paid = models.BooleanField(default=False, verbose_name='Cancelado')
    amount_paid = models.DecimalField(max_digits=10, decimal_places=2,  blank=True, verbose_name='Monto')
    payment_date = models.DateTimeField( blank=True, verbose_name='Fecha de pago')
    ...
    numberTomb = models.ForeignKey(Tumba, related_name='servicioTumba', on_delete=models.DO_NOTHING, blank=True) 
